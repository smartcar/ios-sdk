...
pod install
```
To consume the in-development SDK locally, add the following to your app's Podfile. Be sure to compile the SDK through Xcode to build the framework binaries.
```
